...
export default function BuildEntry({ children }: { children: ReactNode }) {
  ...
  return <SafeAreaView style={s.screen}>
    ...
    <ScrollView contentContainerStyle={s.content}>
      ...
      <Text accessibilityRole="header" accessibilityLiveRegion="polite" style={s.title}>{content.title}</Text><Text style={s.body}>{content.body}</Text>
    </ScrollView>
